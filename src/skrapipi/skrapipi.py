...
def url_effects(pages_read):
    return "https://api.beta.dofusdb.fr/effects?$limit=50&$skip=" +str(pages_read*50)
def url_characteristics(pages_read):
    return "https://api.beta.dofusdb.fr/characteristics?$limit=50&$skip=" +str(pages_read*50)
def url_item_types(pages_read):
    return "https://api.beta.dofusdb.fr/item-types?$limit=50&$skip=" +str(pages_read*50)
def url_item_sets(pages_read):
    return "https://api.beta.dofusdb.fr/item-sets?$limit=50&$skip=" +str(pages_read*50)
def url_items(pages_read, type_id):
    return "https://api.beta.dofusdb.fr/items?$limit=50&typeId=" + str(type_id) + "&$skip=" +str(pages_read*50)
